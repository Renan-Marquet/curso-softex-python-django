...
class UserService:
    ...
    def test_safe_user_data(self, user) -> dict | None:
        ...
        """
        este é um método privado que recebe um usuários do banco.
        verifique se o usuários existe e então retorne ele sem a sua senha
        vcaso ele ão exista retorne None
        """
...
def test_login_user(self, email: str, senha: str) -> tuple[dict | None, str]:
        """
...
def test_get_user_by_id(self, user_id: int) -> dict | None:
        """
...
def test_get_all_users(self) -> list[dict | None]:
        """
