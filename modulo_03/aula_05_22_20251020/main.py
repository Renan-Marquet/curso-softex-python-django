...
adress_model = AdressModel(db_conn)
...
def handle_student_management():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("\n--- Lista de Alunos ---")
            students = adress_model.get_all_students_by_adress()
            if students:
                for student in students:
                    print(
                        f"ID: {student['a.id']} | Nome: {student['a.nome']} | E-mail: {student['a.email']}"
                        f"Endereço {student['e.local']} | Número: {student['e.num']}"
                        f"*****************************************"
                    )
            else:
                print("Nenhum aluno cadastrado.")
