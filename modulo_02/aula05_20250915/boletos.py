...
def pagar_boleto(usuario: dict) -> None:
    ...
    try:
        valor_boleto=float(input("Entre com o valor a ser pago -> "))
        ...
        if valor_boleto > 0 and valor_boleto <= limite_total:
            ...
            print("Boloto pago com sucesso!")
            saldo.verificar_saldo(usuario)

        else:
            print("Saldo insuficente ou valor inválido!")

    except ValueError:
        print("Erro! Por favor, digite apenas números.")

"""
dados=banco_dados.banco_ddos()
