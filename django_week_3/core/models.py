...
# # Um campo de data e hora. # auto_now_add=True: Salva a data e hora EXATAMENTE quando o objeto é criado 
    criada_em = models.DateTimeField(auto_now_add=True) 
# # Este é um "método mágico" do Python. # Ele diz ao Django como "chamar" um objeto Tarefa. 
